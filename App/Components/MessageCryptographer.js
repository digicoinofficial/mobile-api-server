let digicoincore = require('digicoincore-lib');
let _ = digicoincore.deps._;
let PrivateKey = digicoincore.PrivateKey;
let PublicKey = digicoincore.PublicKey;
let Address = digicoincore.Address;
let BufferWriter = digicoincore.encoding.BufferWriter;
let ECDSA = digicoincore.crypto.ECDSA;
let Signature = digicoincore.crypto.Signature;
let sha256sha256 = digicoincore.crypto.Hash.sha256sha256;
let $ = digicoincore.util.preconditions;
