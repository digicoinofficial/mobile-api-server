...
const logger = require('log4js').getLogger('DigiCoinRoomEvents Socket Events');
...
class DigiCoinRoomEvents {
    ...
    initRemoteSocket() {
        ...
        this.socketClient.on('connect', () => {
            ...
            this.subscribeRemoteDigiCoinRoom();
        });
        ...
        this.subscribeToDigiCoinBlock();
        this.subscribeToDigiCoinTrx();

    }

    subscribeToDigiCoinBlock() {

        this.socketClient.on('digicoin/block', (data) => {
    ...
    subscribeToDigiCoinTrx() {

        this.socketClient.on('digicoin/tx', (data) => {
    ...
    subscribeRemoteDigiCoinRoom() {
        this.socketClient.emit('subscribe', 'digicoin');
    }
...
module.exports = DigiCoinRoomEvents;