...
const DigiCoinRoomEvents = require('../Components/SocketEvents/DigiCoinRoomEvents');
...
class SocketController {
    ...
    initSocketEvents() {
        ...
        this.events.digicoinRoomEvents = new DigiCoinRoomEvents(this.socket, this.socketClient);
    ...
    socketHandler(socket) {
        ...
        socket.on('disconnect', () => {
            ...
            this.events.digicoinRoomEvents.unsubscribeAddress(socket, null);
    ...
    subscribe_balance_change(socket, addresses, options) {
        ...
        this.events.digicoinRoomEvents.subscribeAddress(socket, addresses);
    ...
    unsubscribe_balance(socket, addresses, options) {
        ...
        this.events.digicoinRoomEvents.unsubscribeAddress(socket, addresses);
